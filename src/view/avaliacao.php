...
<div class="lg:bg-[url(../imgs/fundoAvaliacao.png)] h-screen bg-cover bg-center">
    ...
    <div class="flex justify-center items-center flex-col gap-14 mt-5 lg:flex-row">
        ...
        <div class="flex flex-col justify-center bg-[#9E8CBE] rounded-4xl w-62 px-5 py-4 relative group"
            ...
            <img src="../imgs/icones/emojiRuim.png" alt="Emoji feliz">
            ...
            <div class="text-center">
                ...
                <div
                    ...
                    <button type=""
                        class="mt-2 bg-[#746587] text-[#F8FBA6] px-3 py-1 transition duration-300 hover:bg-[#625672]"
        ...
        <!--Card de avalião boa-->
        <div class="flex flex-col justify-center flex-justify-center bg-[#9E8CBE] rounded-4xl w-62 px-5 py-4 relative group"
            style="box-shadow: 8px 8px 0px #605470">
            <div class="absolute top-0 right-0 bg-[#AE99D2] h-8 w-8 rounded-tr-4xl"></div>
            <div class="absolute top-20 left-0 bg-[#AE99D2] h-4 w-7"></div>
            <div class="absolute bottom-10 right-0 bg-[#AE99D2] h-4 w-4"></div>
            ...
            <img src="../imgs/icones/emojiBoa.png" alt="Emoji feliz">
        ...
        <div class="flex flex-col justify-center flex-justify-center bg-[#9E8CBE] rounded-4xl w-62 px-5 py-4 relative group"
            ...
            <img src="../imgs/icones/emojiOtima.png" alt="Emoji feliz">
