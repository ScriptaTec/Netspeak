...
<body class="jersey">
    ...
    <div class="text-center mt-1 text-xl">
        <h3>Se cadastrando e tendo acesso a <span style="color:#574d6b">ferramenta de tradução</span> <a
                href="cadastro.php" class="underline">clicando aqui!</a></h3>
    </div>
            ...
            <div class="flex justify-between">
                ...
                <div class="flex flex-col">
                    ...
                    <a href="../view/cadastro.php"
                        class="hover:text-[color:#f5bd20] transition duration-700">Cadastro</a>
                ...
                <div class="flex flex-col">
                    ...
                    <a href="../index.php" class="hover:text-[color:#f5bd20] transition duration-700">Tradutor</a>
